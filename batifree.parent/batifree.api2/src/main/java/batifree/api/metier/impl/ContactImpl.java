...
public abstract class ContactImpl extends MetierImpl<Integer> implements IContact {
	...
	@Override
	public IBinaire getRemarques() throws BatifreeException {
		return ApplicationBf.getApplication().getBinaireManager().getById(remarquesId);
	}
	...
	@Override
	public IBinaire getRappelMotif() throws BatifreeException {
		return ApplicationBf.getApplication().getBinaireManager().getById(rappelMotifId);
	}
	...
	public ICoordonneeCnt getCoordonnee() throws BatifreeException {
		return ApplicationBf.getApplication().getCoordonneeCntManager().getById(coordonneId);
	}
	...
	@Override
	public IActivite getActivite() throws BatifreeException {
		return ApplicationBf.getApplication().getActiviteManager().getById(activiteId);
	}
	...
	@Override
	public ICategorie getCategorie() throws BatifreeException {
		return ApplicationBf.getApplication().getCategorieManager().getById(categorieId);
	}
