...
public class CoordonneeCntImpl extends MetierImpl<Integer> implements ICoordonneeCnt {
	...
	@Override
	public IPays getPays() throws BatifreeException {
		return ApplicationBf.getApplication().getPaysManager().getById(paysId);
	}
	...
	@Override
	public ICivilite getCivilite() throws BatifreeException {
		return ApplicationBf.getApplication().getCiviliteManager().getById(civiliteId);
	}
	...
	@Override
	public ILocalisation getLocalisation() throws BatifreeException {
		return ApplicationBf.getApplication().getLocalisationManager().getById(localisationId);
	}
