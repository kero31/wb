...
public class TestBenchmarkBeans extends TestCommunBfApi {
	 ...
	 */
	private void testAddAll() throws BatifreeException {
	 ...
	 * @throws BatifreeException
	 */
	private void testGetList() throws BatifreeException {
	...
	/*
	@Test
	public void testGetListBoucle() throws BatifreeException {
		for (int i = 0; i < 100; i++) {
			testGetList();
		}
	}*/
