...
public class TestBeans extends TestCommunBfApi {
	...
	private void testGetOne() throws WebbatiException {
	...
	private void testGet() throws WebbatiException {
	...
	private void testUpdate() throws WebbatiException {
	...
	@Test
	public void testTransaction() throws WebbatiException {
		beginTransaction();
		try {
			commitTransaction();
	 ...
	 */
	private void testAdd() throws WebbatiException {
	...
	@SuppressWarnings("unused")
	private void testAddOne() throws WebbatiException {
		// beginTransaction();
		try {
			IFactoryBf factory = app.getFactory();
	...
	@SuppressWarnings("unused")
	private void testUpdateOne() throws WebbatiException {
		beginTransaction();
		try {
	...
	@SuppressWarnings("unused")
	private void testDeleteOne() throws WebbatiException {
		beginTransaction();
		try {
