...
/**
 * 
 * Classe/Interface <CommonHibernateStrategy>
 *
 */
public class CommonHibernateStrategy extends DelegatingReverseEngineeringStrategy {
	 ...
	 */
	public CommonHibernateStrategy(ReverseEngineeringStrategy pDelegate) {
		super(pDelegate);
	}
