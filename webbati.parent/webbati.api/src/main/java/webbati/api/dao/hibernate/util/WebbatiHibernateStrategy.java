...
/**
 * 
 * Classe/Interface <b>WebbatiHibernateStrategy</b><br/>
 *
 */
public class WebbatiHibernateStrategy extends DelegatingReverseEngineeringStrategy {
	 ...
	 */
	public WebbatiHibernateStrategy(ReverseEngineeringStrategy pDelegate) {
		super(pDelegate);
	}
