...
/**
 * 
 * Classe/Interface <BfTraceInvocation>
 *
 */
@Aspect
@Component
public class BfTraceInvocation implements Ordered {
	private static final Logger LOGGER = Logger.getLogger(BfTraceInvocation.class);
	 ...
	 * @throws Throwable
	 */
	@Around("execution(* webbati.api.manager.impl.*.*(..))")
