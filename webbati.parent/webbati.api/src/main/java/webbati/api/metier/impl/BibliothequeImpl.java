...
import webbati.api.manager.interfaces.ISousTacheManager;
...
public abstract class BibliothequeImpl extends LigneImpl<IBibliotheque, Integer> implements IBibliotheque {
	...
	@Override
	public IBinaire getDescriptionTechnique() throws WebbatiException {
		return ApplicationWb.getApplication().getBinaireManager().getById(descriptionTechniqueId);
	}
	...
	@Override
	public IBinaire getDescriptionCommerciale() throws WebbatiException {
		return ApplicationWb.getApplication().getBinaireManager().getById(descriptionCommercialeId);
	}
	...
	@Override
	public IImage getImage() throws WebbatiException {
		return ApplicationWb.getApplication().getImageManager().getById(imageId);
	}
	...
	@Override
	public ITva getTva() throws WebbatiException {
		return ApplicationWb.getApplication().getTvaManager().getById(tvaId);
	}
	...
	@Override
	public IFamille getFamille() throws WebbatiException {
		return ApplicationWb.getApplication().getFamilleManager().getById(familleId);
	}
	...
	@Override
	public <BIBD extends IBibliotheque> BIBD getClone() throws WebbatiException {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public <BIBD extends IBibliotheque> BIBD getCloneForImport() throws WebbatiException {
		BIBD bib = (BIBD) getFactory().createNewInstance(this);
	 ...
	 * @throws WebbatiException
	 */
	public <BIBD extends IBibliotheque> BIBD getCloneForImport(Class<BIBD> pInterfaceDest) throws WebbatiException {
	 ...
	 * @throws WebbatiException
	 */
	public List<ITache> getListTacheParente() throws WebbatiException {
	 ...
	 * @throws WebbatiException
	 */
	protected IFactoryBf getFactory() throws WebbatiException {
		return ApplicationWb.getApplication().getFactory();
	}
	 ...
	 * @throws WebbatiException
	 */
	public IEtude getEtude() throws WebbatiException {
		return ApplicationWb.getApplication().getEtudeManager().getById(etudeId);
	}
	 ...
	 * @throws WebbatiException
	 */
	public IBibEltBib getElementOrigin() throws WebbatiException {
	...
	@Override
	protected List<IBibliotheque> getListLigneFromManager() throws WebbatiException {
