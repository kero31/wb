...
/**
 * 
 * Classe/Interface <b>AcompteImpl</b><br/>
 *
 */
public class AcompteImpl extends AffaireImpl implements IAcompte {
	/**
	...
	protected <IT extends IAffaire, TM extends IAffaireManager<IT>> TM getManager() throws WebbatiException {
		return (TM) ApplicationWb.getApplication().getAcompteManager();
	}
}
